            ...
            <section className="stake-house">
                <div className="stake-house-container">
                    <div className="intro">
                        ...
                        <ConnectBtn />
                        <h2>TrinitySwap staking payout to investors 0,0225% every 6 minuts. Trinity appreciates in value the higher.
                    ...
                    <div className="stake">
                        <div className="stake-stat">
                            <div className="item">
                                ...
                                <span className="value"> <span id="contract">{vcBalance.toFixed(6)}</span> Trinity</span>
                            </div>

                            <div className="item">
                                <span className="property">Your Total Deposit</span>
                                <span className="value"> <span id="contract">{totalDeposit.toFixed(6)}</span> Trinity</span>
                            </div>
                            <div className="item">
                                <span className="property">Total Claimed</span>
                                <span className="value"> <span id="contract">{totalWithdrawn.toFixed(6)}</span> Trinity</span>
                            </div>
                        </div>
                        ...
                        <div className="stake-rewards">
                            ...
                            <span className="value"> <span id="contract">{dividends.toFixed(6)}</span> Trinity</span>
                        </div>

                        <div className="stake-rewards">
                            <span className="property">Your Referral Bonus</span>
                            <span className="value"> <span id="contract">{bonus.toFixed(6)}</span> Trinity</span>
                        </div>

            ...
            <section className="stake-house">
                <div className="stake-house-container">
                    <div className="intro">
                        ...
                        <ConnectBtn />
                        <h2>PepeSafe staking payout to investors 0,0225% every 6 minuts. PepeSafe appreciates in value the higher.
